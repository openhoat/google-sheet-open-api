...
To get an access_token for test purpose, see the example in [samples/gauth.js](https://raw.github.com/openhoat/google-sheet-open-api/samples/gauth.js) and the [official doc](https://developers.google.com/accounts/docs/OAuth2).
